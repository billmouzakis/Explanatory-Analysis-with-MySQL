-- Σε αυτό το αρχείο θα κάνουμε ένα Data Cleaning Project

-- Φτιάξαμε ένα καινούργιο schema και εισηγάγαμε τα δεδομένα ως εξής:
-- 1) Κατεβάσμε τα δεδομένα στον υπολογιστή
-- 2) Κάναμε δεξί κλικ στο πεδίο Tables και επιλέξαμε "Table Data Import Wizard"
-- Αξίζει να σημειωθεί ότι κατά την διαδικασία αυτή έχουμε ένα preview των δεδομένων και μπορούμε να δούμε τι τύπου θεωρεί ότι είναι τα δεδομένα κάθε στήλης.
-- Βλέπουμε ότι η στήλη που έχει την ημερομηνία την βλέπει σαν μια στήλη δεδομένων text. Αυτό μπορούμε να το αλλάξουμε αλλά για την ώρα το αφήσαμε έτσι.
